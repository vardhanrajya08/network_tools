// This program will power on the switched-off PC whose MAC Address is used in this program using the Wake-on-LAN protocol.
// The  PC and the Host computer must be connected over LAN.
